...
int main(void) {
	...
	setbuf(stdout, NULL);
	eClientes clientes[CANT_CLIENTES];/* = {{1, "Zara", "26-12458796-4", {"Mariano Acosta", 236}, "Parque Chacabuco", OCUPADO},
										 {2, "Forever 21", "27-31546987-8", {"Av Avellaneda" , 123}, "Villa Soldati", OCUPADO},
										 {3, "Pepsi", "30-45987621-3", {"Emilio Mitre"  , 654}, "Floresta", OCUPADO},
										 {4, "Mala mia", "31-36926395-5", {"Agustin de Vedia", 789}, "Boedo", OCUPADO},
										 {5, "Jumbo" , "32-12457214-4", {"Av Cordoba" ,1234}, "Flores", OCUPADO}};*/
	...
	do{
		...
		switch(opcion)
		{
			...
			case 9:
				if(CantidadPedidosPendientesPorLocalidad (pedidos, CANT_PEDIDOS,clientes, CANT_CLIENTES)==-1)
				{
					printf("\nNo se pudo contar\n");
				}
				break;
