...
/// @fn int AltaPedidoDeRecoleccion(eClientes[], int, ePedidos[], int, int*, eLocalidad[], int)
/// @brief Funcion que hara un alta de pedidos luego de comprobar la existencia del id del cliente que ingreso
...
/// @param idPedidos Direccion de memoria que va a ir incrementando cada vez que haya un alta de pedido
...
/// @return Devuelve -1 si es NULL o 1 si es todo ok
